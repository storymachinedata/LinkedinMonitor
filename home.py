...
with col2:
    st.markdown(
        "<div style='text-align: center; font-weight: bold; font-size: 32px;'>Andreas Sticha</div>",
        unsafe_allow_html=True,
    )
    st.markdown(
        "<div style='text-align: center;'><a href='https://andreasticha.streamlit.app/' target='_blank'><img src='https://www.ccfa.at/wp-content/uploads/2020/12/sticha.jpg' width='330'/></a></div>",
        unsafe_allow_html=True,
    )
